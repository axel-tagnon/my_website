...
- ""
date: "`r Sys.Date()`"
description: Data Analytics Project 3 # the title that will show up once someone gets to this page
draft: false

keywords: ""
slug: proj3 # slug is the shorthand URL address... no spaces plz
...
UN_GDP_data  <-
  read_excel(
    here::here("data", "Download-GDPconstant-USD-countries.xlsx"),
    # Excel filename
...
needed_GDP_data <- needed_GDP_data[, c(2, 6, 7, 8,9,10)] %>%
...
-   Who did you collaborate with: B11
-   Approximately how much time did you spend on this problem set: 1d
